...
class ZegoServerAssistant
{
     ...
     *
     * @param  int  $appId  Digital ID distributed by Zego, unique identifier for each developer
     * @param  string  $userId  User ID
     * @param  string  $secret  Secret key corresponding to appId provided by Zego, please keep it safe and do not disclose it
     * @param  int  $effectiveTimeInSeconds  The valid period of the token, in seconds
