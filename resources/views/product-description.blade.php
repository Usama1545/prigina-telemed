...
@section('content')
    @component('components.breadcrumb', ['title' => 'Pharmacy', 'li_1' => 'Product Description', 'li_2' => 'Product Description'])
    @endcomponent
                            ...
                            <div class="doctor-widget">
                                <div class="doc-info-left">
                                    <div class="doctor-img1">
                                        <img src="{{URL::asset('build/img/products/product.jpg')}}" class="img-fluid"
                                            alt="User Image">
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="widget about-widget">
                                                ...
                                                <p>Safi syrup is best for purifying the blood. As it contains herbal
                                                    ...
                                                    boils. It helps in the removal of the toxins from the blood. It improves
                                                    the complexion and gives you a healthy life</p>
                                            </div>
                                            <!-- /About Details -->
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="experience-content">
                                                                <div class="timeline-content">
                                                                    <p>Safi syrup is known for its best purifying syrup for
                                                                        blood.</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                            ...
                                            <div class="widget about-widget">
                                                ...
                                                <p>Store this syrup at room temperature protected from sunlight, heat, and
                                                    moisture. Keep away from reaching out of children and pets. Ensure that
                                                    the unused medicine is disposed of properly.</p>
                                            </div>
                                            <!-- /About Details -->
                                            <!-- About Details -->
                                            <div class="widget about-widget">
                                                <h4 class="widget-title">Administration Instructions</h4>
                                                <p>Shake the bottle before its use. This syrup can be taken with or without
                                                    food. The quantity consumed should not be lesser or greater than the
                                                    prescribed one.</p>
                                            </div>
                                            <!-- /About Details -->
                                            ...
                                            <div class="widget about-widget mb-0">
                                                ...
                                                <p class="mb-0">Syrup has to be disposed of properly after 3 years from
                                                    manufactured date and it is not recommended to use after the date.</p>
                                            </div>
                                            <!-- /About Details -->
                                        </div>
                                    </div>
                    ...
                    <div class="card search-filter">
                        <div class="card-body">
                            <div class="clini-infos mt-0">
                                <h2>$19 <b class="text-lg strike">$45</b> <span class="text-lg text-success"><b>10%
                                            off</b></span></h2>
                            </div>
                            ...
                            <div class="clinic-details mt-4">
                                <div class="clinic-booking">
                                    <a class="btn btn-primary" href="{{url('cart')}}">Add To Cart</a>
                                </div>
                            </div>
                            <div class="card flex-fill mt-4 mb-0">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item text-gray-6">SKU <span class="float-end">2023-02-0057</span>
                                    </li>
                                    <li class="list-group-item text-gray-6">Pack Size <span class="float-end">100g</span>
                                    </li>
                                    <li class="list-group-item text-gray-6">Unit Count <span class="float-end">200ml</span>
                                    </li>
                                    <li class="list-group-item text-gray-6">Country <span class="float-end">Japan</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
