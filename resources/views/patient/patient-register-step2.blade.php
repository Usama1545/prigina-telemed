                    ...
                    <div class="login-right">
                        <div class="inner-right-login">
                            <div class="login-header">
                                <div class="logo-icon">
                                    <img src="{{ URL::asset('build/img/logo.png') }}" alt="doccure-logo">
                                </div>
                                <div class="step-list">
                                    <ul>
                                ...
                                <form id="personal_details" enctype="multipart/form-data">
                                    ...
                                    <div class="select-gender-col">
                                        <div class="row">
                                            <div class="col-6 pe-2">
                                                ...
                                                <label for="test1">
                                                    <span class="gender-icon"><img
                                                            src="{{ URL::asset('build/img/icons/male.png') }}"
                                                            alt="male-icon"></span>
                                                    <span>Male</span>
                                                </label>
                                            </div>
                                            <div class="col-6 ps-2">
                                                ...
                                                <label for="test2">
                                                    <span class="gender-icon"><img
                                                            src="{{ URL::asset('build/img/icons/female.png') }}"
                                        ...
                                        <div>
                                            <div class="remember-me-col d-flex justify-content-between">
                                                ...
                                                <label class="custom_check">
                                                    <input type="checkbox" class="form-control" id="is_registered"
                                    ...
                                    <div class="step-process-col mt-4">
                                        <div class="mb-3" id="preg_div" style="display: none;">
                                            ...
                                            <select class="form-select form-control" id="preg_term" name="preg_term"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5 ps-2">
                                                    <select class="form-select form-control" id="weight_unit"
                                                        name="weight_unit">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5 ps-2">
                                                    <select class="form-select form-control" id="height_unit"
                                                        name="height_unit" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-control" id="blood_group" name="blood_group"
                                                tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-control" id="heart_rate" name="heart_rate"
                                                tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-control" id="bp" name="bp"
                                                tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-control" id="glucose" name="glucose"
                                                tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="" id="allergies"
                                                name="allergies">
                                        </div>
                                        <div class="checklist-col pregnant-col">
                                            ...
                                            <div class="remember-me-col" id="cancer_div" style="display:none">
                                                ...
                                                <a href="javascript:void(0);" class="add_condition"><i
                                                        class="fa fa-plus"></i></a>
                                            </div>
                                            <div class="remember-me-col d-flex justify-content-between">
                                                <span class="mt-1">Are you currently taking any medication</span>
                                                <label class="custom_check mb-3">
                                                    <input type="checkbox" class="form-control" name="medicine"
                                                        id="medicine" value="1">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="remember-me-col" id="medicine_div" style="display:none">
                                                <div class="medicine_input">
                                                    ...
                                                    <input type="text" value="" id="dosage" name="dosage[]"
                                                        class="form-control" placeholder="Enter dosage">
                                                </div>
                                                <a href="javascript:void(0);" class="add_medicine"><i
                                                        class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-5">
                                        <a href="{{ url('patient-register-step3') }}"
                        ...
                        <div class="login-bottom-copyright">
                            <span>© 2024 PriGina Global Telemed. All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </div>
