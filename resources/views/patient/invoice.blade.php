...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .status-bar .pill.cancelled { background: #dc2626; }
        .status-bar .pill.pending   { background: #d97706; }
        .status-bar span.label { font-size: 13px; color: #475569; }
        ...
        .party p { font-size: 14px; color: #334155; line-height: 1.7; }
        .party p strong { color: #0f172a; font-size: 15px; }
        ...
        .payment-info .pi-row:last-child { margin-bottom: 0; }
        .payment-info .pi-label { color: #64748b; min-width: 150px; }
        .payment-info .pi-value { font-weight: 600; color: #0f172a; word-break: break-all; }
...
<div class="page">
    ...
    <div class="status-bar">
        ...
        <span class="label">Payment status for appointment #{{ strtoupper(substr($appointment['id'] ?? '', 0, 8)) }}</span>
    </div>
    ...
    <div class="inv-body">
        ...
        <div class="parties">
            <div class="party">
                ...
                <p>
                    ...
                    @if(!empty($appointment['email'])){{ $appointment['email'] }}<br>@endif
                    @if(!empty($appointment['phone'])){{ $appointment['phone'] }}@endif
                </p>
            </div>
            <div class="party">
            ...
            <div class="party">
                ...
                <p>
                    ...
                    @if(!empty($appointment['specialty'])){{ $appointment['specialty'] }}@endif
                </p>
            </div>
        </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <span style="font-size:12px; color:#64748b;">with Dr. {{ $appointment['doctorName'] ?? 'N/A' }}</span>
                    </td>
                    <td>
                        @php
                    ...
                    <td>{{ $appointment['patientLocalTime'] ?? (($appointment['startTime'] ?? '') . ' – ' . ($appointment['endTime'] ?? '')) }}</td>
        ...
        <div class="payment-info">
            ...
            <div class="pi-row">
                ...
                <span class="pi-value">{{ \Carbon\Carbon::parse($appointment['paymentCompletedAt'])->format('d M Y, h:i A') }}</span>
            </div>
            @endif
            <div class="pi-row">
