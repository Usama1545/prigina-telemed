...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        #zego-container { width: 100%; height: 100vh; }

        #errBanner {
            display: none;
            position: fixed; top: 0; left: 0; right: 0; z-index: 9999;
            background: #7f1d1d; color: #fca5a5;
            padding: 12px 20px; font-size: 13px; font-weight: 600; text-align: center;
        }
        #errBanner a { color: #fde68a; margin-left: 16px; cursor: pointer; text-decoration: underline; }
        ...
        #dbgLog {
            ...
            font-size: 11px; color: #94a3b8; padding: 8px;
        }
        #dbgLog .e { color: #f87171; }
        #dbgLog .s { color: #86efac; }
        #dbgToggle {
            position: fixed; bottom: 8px; right: 8px; z-index: 10000;
