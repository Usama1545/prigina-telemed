<?php $page = 'patient-completed-appointment'; ?>
                            ...
                            <ul class="detail-card-bottom-info">
                                ...
                                <li class="detail-badge-info">
                                    <a href="#view_prescription" data-bs-toggle="modal"
                                        class="btn btn-light rounded-pill me-3">Download Prescription</a>
                                    <a href="#" class="btn reschedule-btn btn-primary-gradient rounded-pill">Reschedule
                                        Appointment</a>
                                </li>
                            </ul>
                        </div>
