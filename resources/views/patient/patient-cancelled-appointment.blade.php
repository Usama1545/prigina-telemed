...
@section('content')
    @component('components.breadcrumb', ['title' => 'Patient', 'li_1' => 'Appointments', 'li_2' => 'Cancelled Appointment'])
    @endcomponent
                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="dashboard-header">
                        <div class="header-back">
                            <a href="{{url('patient-appointments')}}" class="back-arrow"><i
                            ...
                            <ul class="detail-card-bottom-info">
                                ...
                                <li>
                                    <div class="detail-badge-info">
                                        ...
                                        <a href="{{url('booking-popup')}}"
                                            class="reschedule-btn btn btn-primary-gradient rounded-pill">Reschedule
                                            Appointment</a>
                                    </div>
                                </li>
                            </ul>
