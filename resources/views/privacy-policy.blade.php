...
@section('content')
    ...
    <div class="terms-section py-5">
        <div class="container">
            ...
            <div class="terms-text mb-4">
                <p>
                    PriGina Global TeleMed (“PriGina,” “we,” “our,” or “us”) is committed to protecting your privacy and
                    safeguarding your personal and medical information.
                </p>
                <p>
                    This Privacy Policy explains how we collect, use, disclose, and protect your information when you use
                    our website, mobile application, and second-opinion telemedicine services.
                </p>
                <p>
            ...
            <div class="terms-text mb-4">
                ...
                <p>
                    If you are located in the United States, your Protected Health Information (PHI) is handled in
            ...
            <div class="terms-text mb-4">
                ...
                <p>Contact us at: <strong>info@priginaglobaltelemed.com</strong></p>
            </div>
