            ...
            <div class="col-md-12 col-12 text-center">
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        @if(isset($title) && !Route::is(['about-us', 'booking-1', 'booking-2', 'calendar', 'components', 'contact-us', 'clinic', 'faq', 'invoice-view', 'pricing', 'privacy-policy', 'terms-condition', 'video-call', 'voice-call', 'speciality', 'hospitals']))
