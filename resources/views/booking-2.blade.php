...
@section('content')
    @component('components.breadcrumb', ['li_1' => 'Booking', 'li_2' => 'Booking'])
    @endcomponent
                    ...
                    <div class="booking-date choose-date-book">
                        ...
                        <div class="booking-range">
                            <div class="bookingrange btn">
                                <img src="{{URL::asset('build/img/icons/today-icon.svg')}}" alt="calendar-mage">
                                <span></span>
                                ...
                                <div class="booking-doctor-left">
                                    <div class="booking-doctor-img">
                                        <a href="{{url('doctor-profile')}}">
                                            <img src="{{URL::asset('build/img/doctors/doctor-01.jpg')}}" alt="John Doe">
                                        </a>
                                    </div>
