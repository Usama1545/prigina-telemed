                                    ...
                                    <tr data-status="{{ $report['status'] }}">
                                        <td>
                                            <span class="fw-semibold"
                                                style="color:#1d4ed8;">{{ $report['report_number'] ?? '—' }}</span>
                                        </td>
                                        <td>{{ $report['patient_information']['patient_name'] ?? '—' }}</td>
                                        <td>
                                            <small class="text-muted">ID:
                                                {{ substr($report['doctor_id'] ?? '—', 0, 12) }}…</small>
                                        </td>
                                        <td>
                                            <small
                                                class="text-muted">{{ substr($report['appointment_id'] ?? '—', 0, 12) }}…</small>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                [$color, $label] = $statusMap[$report['status'] ?? 'draft'] ?? [
                                                    'secondary',
                                                    $report['status'],
                                                ];
                                            @endphp
