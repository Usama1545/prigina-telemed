...
@section('content')
            ...
            <div class="row g-3 mb-4">
                @foreach ($statCards as $card)
                    <div class="col-6 col-sm-4 col-lg">
                        <div class="card appt-stat h-100" data-filter-type="{{ $card['type'] }}"
                            data-filter-val="{{ $card['val'] }}" data-color="{{ $card['color'] }}" style="cursor:pointer">
                            <div class="card-body py-3 px-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h5 class="fw-bold mb-0" style="color:#0f172a">{{ number_format($card['count']) }}
                                        </h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <button type="button" id="nextAppointments" class="btn btn-sm btn-outline-primary"
                                        ...
                                        @forelse($appointments as $appointment)
                                            ...
                                            <tr>
                                                    ...
                                                    <h2 class="table-avatar">
                                                        <a href="{{ url('admin/profile') }}" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="{{ asset('build/admin/img/doc-placeholder.png') }}"
                                                                alt="">
                                                        </a>
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="badge {{ $payStatus === 'completed' ? 'bg-success' : 'bg-secondary' }}">
                                                        ...
                                                        <div class="d-flex flex-column gap-1">
                                                            ...
                                                            <form method="POST"
                                                                ...
                                                                <button type="submit" class="btn btn-success btn-sm w-100"
                                                                    {{ $canRelease ? '' : 'disabled' }}>Release</button>
                                                            </form>
                                                            <form method="POST"
                                                                action="{{ route('admin.appointments.payment.refund', $apptId) }}">
                                                                @csrf
                                                                <button type="submit" class="btn btn-danger  btn-sm w-100"
                                                                    {{ $canRefund ? '' : 'disabled' }}>Refund</button>
                                                            </form>
                                                        </div>
                                                    @endif
                                                </td>
    ...
    <script>
        ...
        const LOADING_ROW =
            `<tr><td colspan="6" class="text-center py-4">${SPINNER_SM} <span class="ms-2 text-muted">Loading…</span></td></tr>`;
    ...
    <tr>
        ...
        nextBtn.addEventListener('click', () => {
            ...
            pageIndex++;
            fetchPage(nextCursor, nextBtn);
        });
        prevBtn.addEventListener('click', () => {
            if (!cursorStack.length) return;
            pageIndex--;
            fetchPage(cursorStack.pop(), prevBtn);
        });
