...
@section('content')
    @component('components.breadcrumb', ['title' => 'Doctor', 'li_1' => 'My Patients', 'li_2' => 'My Patients'])
    @endcomponent
                            ...
                            <ul class="nav nav-pills inner-tab " id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-upcoming-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-upcoming" aria-selected="false">Active<span>200</span></button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                    <div class="appointment-wrap appointment-grid-wrap">
                                        <ul>
                                            ...
                                            <li class="appointment-action">
                                                <div class="patient-book">
                                                    <p><i class="isax isax-calendar-1"></i>Last Booking<span>20 Mar
                                                            2024</span></p>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                    <div class="appointment-wrap appointment-grid-wrap">
                                        <ul>
                                            ...
                                            <li class="appointment-action">
                                                <div class="patient-book">
                                                    <p><i class="isax isax-calendar-1"></i>Last Booking<span>12 Mar
                                                            2024</span></p>
                                            ...
                                            <li>
                                                <div class="appointment-grid-head">
                                                    <div class="patinet-information">
                                                        ...
                                                        <div class="patient-info">
                                                            <p>#Apt0004</p>
                                                            <h6><a href="{{url('patient-profile')}}">Catherine Gracey</a>
                                                            </h6>
                                                            <ul>
                                                                <li>Age : 36</li>
                                                                <li>Female</li>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                    <div class="appointment-wrap appointment-grid-wrap">
                                        <ul>
                                            ...
                                            <li class="appointment-action">
                                                <div class="patient-book">
                                                    <p><i class="isax isax-calendar-1"></i>Last Booking<span>18 Feb
                                                            2024</span></p>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                    <div class="appointment-wrap appointment-grid-wrap">
                                        <ul>
                                            ...
                                            <li class="appointment-action">
                                                <div class="patient-book">
                                                    <p><i class="isax isax-calendar-1"></i>Last Booking<span>25 Jan
                                                            2024</span></p>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                                    <div class="appointment-wrap appointment-grid-wrap">
                                        <ul>
                                            ...
                                            <li class="appointment-action">
                                                <div class="patient-book">
                                                    <p><i class="isax isax-calendar-1"></i>Last Booking<span>13 Jan
                                                            2024</span></p>
