                    ...
                    <div class="row">
                        <div class="col-lg-12 mx-auto">
                            <div class="booking-wizard">
                                <ul class="form-wizard-steps d-flex align-items-center justify-content-center"
                                    id="progressbar2">
                            ...
                            <div class="booking-widget multistep-form">
                                <fieldset id="first">
                                                ...
                                                <div class="card mb-0">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center">
                                                            <span class="avatar avatar-xxxl avatar-rounded me-2"><img
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="mb-0"><i class="isax isax-location me-2"></i>5th
                                                                    Street - 1011 W 5th St, Suite 120, Austin, TX 78703</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-6">
                                                            <div class="service-item active">
                                                                ...
                                                                <label class="form-check-label ms-2" for="service1">
                                                                    <span
                                                                        class="service-title d-block mb-1">Echocardiograms</span>
                                                        ...
                                                        <div class="col-lg-4 col-md-6">
                                                            <div class="service-item">
                                                                ...
                                                                <label class="form-check-label ms-2" for="service2">
                                                                    <span class="service-title d-block mb-1">Stress
                                                                        tests</span>
                                            ...
                                            <div class="card mb-0">
                                                <div class="card-body pb-1">
                                                    ...
                                                    <div>
                                                        <div class="service-item">
                                                            ...
                                                            <label class="form-check-label ms-2" for="service12">
                                                                <span class="d-flex align-items-center">
                                                                    ...
                                                                    <span>
                                                                        <span class="service-title d-block mb-1">AllCare
                                                                            Family Medicine</span>
                                                                        <span class="fs-14">3343 Private Lane,
                                                                            Valdosta</span>
                                                                        <i
                                                                ...
                                                                <span class="d-flex align-items-center">
                                                                    ...
                                                                    <span>
                                                                        <span class="service-title d-block mb-1">Vitalplus
                                                                            Clinic</span>
                                                                        <span class="fs-14">4223 Pleasant Hill Road, Miami,
                                                                            FL 33169</span>
                                                                        <i
                                                                            class="fa-solid fa-circle fs-5 text-primary mx-2 me-1"></i>
                                                        ...
                                                        <div class="service-item">
                                                            <input class="form-check-input ms-0 mt-0" name="service2"
                                                                type="checkbox" id="service14">
                                                            <label class="form-check-label ms-2" for="service14">
                                                                <span class="d-flex align-items-center">
                                                                    <span class="d-inline-block me-2"><img
                                                                            src="{{URL::asset('build/img/icons/clinic-icon-03.svg')}}"
                                                                            class="rounded-circle" alt=""></span>
                                                                    <span>
                                                                        <span class="service-title d-block mb-1">Wellness
                                                                            Path Chiropractic</span>
                                                                        <span class="fs-14">418 Patton Lane, Garner, NC
                                                                            27529, FL 33169</span>
                                                                        <i
                                                                            class="fa-solid fa-circle fs-5 text-primary mx-2 me-1"></i>
                                                            ...
                                                            <div class="payment-tabs">
                                                                ...
                                                                <div class="tab-content" id="pills-tabContent">
                                                                    <div class="tab-pane fade show active" id="pills-home"
                                                                        role="tabpanel">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Card Holder
                                                                                Name</label>
                                                    ...
                                                    <div class="card flex-fill mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="form-plain-text">10:00 - 11:00 AM, 15, Oct 2025
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div
                                                                class="bg-primary d-flex align-items-center justify-content-between p-3 rounded">
                                ...
                                <fieldset>
                                                        ...
                                                        <div class="card ">
                                                            ...
                                                            <div class="card-header d-flex align-items-center">
                                                                ...
                                                                <p class="mb-0">Your Booking has been Confirmed with <span
                                                                        class="text-dark">Dr. Michael Brown </span> be on
                                                                    time before <span class="text-dark">15 Mins </span> From
                                                                    the appointment Time</p>
                                                            </div>
                                                            <div class="card-body pb-1">
                                                                <div
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="form-plain-text">Cardiology (30
                                                                                Mins)</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Additional
                                                                                Service</label>
                                                                            <div class="form-plain-text">Echocardiograms
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Date & Time</label>
                                                                            <div class="form-plain-text">10:00 - 11:00 AM,
                                                                                15, Oct 2025 </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Clinic Name &
                                                                                Location</label>
                                                        ...
                                                        <div class="card-body d-flex flex-column justify-content-between">
                                                            <div class="text-center">
                                                                ...
                                                                <span class="d-block mb-3"><img
                                                                        ...
                                                                        alt=""></span>
                                                                <p>Scan this QR Code to Download the details of Appointment
                                                                </p>
                                                            </div>
                                                            <div>
                                                                <a href="javascript:void(0);"
                                    ...
                                    <div>
                                        <a href="{{url('booking-popup')}}" class="">
                                            <i class="isax isax-arrow-left-2 me-1"></i>
                                            Back to Bookings
                                        </a>
                                    </div>
