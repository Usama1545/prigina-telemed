                    ...
                    <div class="doctor-widget">
                        <div class="doc-info-left">
                            <div class="doctor-img">
                                <img src="{{URL::asset('build/img/doctors/doctor-thumb-02.jpg')}}" class="img-fluid"
                                    alt="User Image">
                            </div>
                            <div class="doc-info-cont">
                                ...
                                <p class="doc-department"><img
                                        src="{{URL::asset('build/img/specialities/specialities-05.png')}}" class="img-fluid"
                                ...
                                <div class="clinic-details">
                                    ...
                                    <ul class="clinic-gallery">
                                        <li>
                                            <a href="{{URL::asset('build/img/features/feature-01.jpg')}}"
                                                data-fancybox="gallery">
                                                <img src="{{URL::asset('build/img/features/feature-01.jpg')}}"
                                                    alt="Feature">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::asset('build/img/features/feature-02.jpg')}}"
                                                data-fancybox="gallery">
                                                <img src="{{URL::asset('build/img/features/feature-02.jpg')}}"
                                                    alt="Feature Image">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::asset('build/img/features/feature-03.jpg')}}"
                                                data-fancybox="gallery">
                                                <img src="{{URL::asset('build/img/features/feature-03.jpg')}}"
                                                    alt="Feature">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{URL::asset('build/img/features/feature-04.jpg')}}"
                                                data-fancybox="gallery">
                                                <img src="{{URL::asset('build/img/features/feature-04.jpg')}}"
                                                    alt="Feature">
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <li>
                                        <div class="comment">
                                            <img class="avatar avatar-sm rounded-circle" alt="User Image"
                                                src="{{URL::asset('build/img/patients/patient.jpg')}}">
                                        ...
                                        <ul class="comments-reply">
                                            <li>
                                                <div class="comment">
                                                    <img class="avatar avatar-sm rounded-circle" alt="User Image"
                                                        src="{{URL::asset('build/img/patients/patient1.jpg')}}">
                                                    <div class="comment-body">
                                                        <div class="meta-data">
