            ...
            <div class="modal-header border-0 p-0">
                <div class="w-100 d-flex align-items-center gap-3 p-4"
                    ...
                    <div id="appt-detail-avatar-wrap" class="flex-shrink-0">
                        ...
                        >
                        <div
                            id="appt-detail-avatar-fallback"
                    ...
                    <div class="flex-grow-1">
                        <p class="mb-0 text-white-50" style="font-size:12px; letter-spacing:.5px; text-transform:uppercase;">
                            #<span id="appt-detail-number"></span>
                        </p>
                        <h5 class="mb-1 fw-bold text-white" id="appt-detail-patient-name"></h5>
                        <span id="appt-detail-status-badge" class="badge px-3 py-1" style="font-size:12px; border-radius:50px;"></span>
                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-3 h-100" style="background:#f0f7ff; border:1px solid #dbeafe;">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span class="text-muted" style="font-size:11px; text-transform:uppercase; letter-spacing:.5px;">Date</span>
                            </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-3 h-100" style="background:#f0fdf4; border:1px solid #bbf7d0;">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span class="text-muted" style="font-size:11px; text-transform:uppercase; letter-spacing:.5px;">Time</span>
                            </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-3 h-100" style="background:#fefce8; border:1px solid #fde68a;">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span class="text-muted" style="font-size:11px; text-transform:uppercase; letter-spacing:.5px;">Amount</span>
                            </div>
                            <p class="mb-0 fw-semibold text-warning" id="appt-detail-amount" style="font-size:14px;"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="p-3 rounded-3 h-100" style="background:#fdf4ff; border:1px solid #e9d5ff;">
                            <div class="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span class="text-muted" style="font-size:11px; text-transform:uppercase; letter-spacing:.5px;">Type</span>
                            </div>
                ...
                <div id="appt-detail-symptoms-section" class="d-none">
                    <div class="p-3 rounded-3" style="background:#f8fafc; border:1px solid #e2e8f0;">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span class="fw-semibold" style="font-size:13px; text-transform:uppercase; letter-spacing:.5px; color:#475569;">Symptoms</span>
                        </div>
                        <p class="mb-0 text-secondary" id="appt-detail-symptoms" style="font-size:14px; line-height:1.6;"></p>
                    </div>
                </div>
                ...
                <div id="appt-detail-notes-section" class="mt-3 d-none">
                    <div class="p-3 rounded-3" style="background:#f8fafc; border:1px solid #e2e8f0;">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <span class="fw-semibold" style="font-size:13px; text-transform:uppercase; letter-spacing:.5px; color:#475569;">Notes</span>
                        </div>
                        <p class="mb-0 text-secondary" id="appt-detail-notes" style="font-size:14px; line-height:1.6;"></p>
                    </div>
                </div>
...
(function () {
    ...
    document.getElementById('appointmentDetailModal').addEventListener('show.bs.modal', function (e) {
        ...
        document.getElementById('appt-detail-time').textContent         = d.start && d.end ? `${d.start} – ${d.end}` : '—';
        ...
        const statusMap = {
            confirmed: { label: 'Confirmed',  bg: '#dcfce7', color: '#15803d', border: '#86efac' },
            pending:   { label: 'Pending',    bg: '#fef9c3', color: '#a16207', border: '#fde047' },
            cancelled: { label: 'Cancelled',  bg: '#fee2e2', color: '#b91c1c', border: '#fca5a5' },
            completed: { label: 'Completed',  bg: '#ede9fe', color: '#6d28d9', border: '#c4b5fd' },
        };
        const s = statusMap[d.status] || { label: d.status || 'Unknown', bg: '#f1f5f9', color: '#475569', border: '#cbd5e1' };
        badge.textContent = s.label;
        badge.style.cssText = `background:${s.bg}; color:${s.color}; border:1px solid ${s.border}; border-radius:50px; font-size:12px;`;
