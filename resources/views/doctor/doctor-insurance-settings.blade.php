        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-xl-9">
                    ...
                    <form action="{{url('doctor-insurance-settings')}}">
                        ...
                        <div class="accordions insurance-infos" id="list-accord">
                            ...
                            <div class="user-accordion-item">
                                <a href="#" class="accordion-wrap" data-bs-toggle="collapse"
                                    data-bs-target="#insurance1">Insurance<span>Delete</span></a>
                            ...
                            <div class="user-accordion-item">
                                <a href="#" class="collapsed accordion-wrap" data-bs-toggle="collapse"
                                    data-bs-target="#insurance2">Star Health<span>Delete</span></a>
