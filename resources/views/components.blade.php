...
@section('content')
    @component('components.breadcrumb', ['li_1' => 'Components', 'li_2' => 'Components'])
    @endcomponent
            ...
            <div class="comp-sec-wrapper">
                                ...
                                <div class="card-body">
                                    <div class="avatar avatar-xxl">
                                        <img class="avatar-img rounded-circle" alt="User Image"
                                            src="{{URL::asset('build/img/patients/patient8.jpg')}}">
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="avatar-group">
                                        ...
                                        <div class="avatar">
                                            <img class="avatar-img rounded-circle border border-white" alt="User Image"
                                                src="{{URL::asset('build/img/patients/patient2.jpg')}}">
                                        </div>
                                        <div class="avatar">
                                            <img class="avatar-img rounded-circle border border-white" alt="User Image"
                                                src="{{URL::asset('build/img/patients/patient3.jpg')}}">
                                        </div>
                                        <div class="avatar">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-4 d-flex">
                            <div class="card flex-fill">
                                <img alt="Card Image" src="{{URL::asset('build/img/img-01.jpg')}}" class="card-img-top">
                                <div class="card-header">
                ...
                <section class="comp-section">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Below is a static modal example (meaning its position and display have been overridden).
                                ...
                                provide another explicit dismiss action.</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Simple demo-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-original-title="test" data-bs-target="#exampleModal">Simple</button>
                            <!-- Scrolling long content-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalLong" data-bs-original-title="" title="">Scrolling long
                                content</button>
                            <!-- Vertically centered modal-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalCenter" data-bs-original-title="" title="">Vertically
                                centered</button>
                            <!-- Tooltips and popovers modal-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#tooltipmodal" data-bs-original-title="" title="">Tooltips and
                                popovers</button>
                            <!-- Using the grid modal-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#grid-modal" data-bs-original-title="" title="">Using the grid</button>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body btn-showcase">
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalfat" data-whatever="@mdo" data-bs-original-title=""
                                title="">Open modal for @mdo</button>
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalmdo" data-whatever="@fat" data-bs-original-title=""
                                title="">Open modal for @fat</button>
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalgetbootstrap" data-whatever="@getbootstrap"
                                data-bs-original-title="" title="">Open modal for @getbootstrap</button>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Extra Large modal -->
                            <button type="button" class="btn btn-primary custom-components" data-bs-toggle="modal"
                                data-bs-target=".bd-example-modal-xl">Extra large modal</button>

                            <!-- Large modal-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target=".bd-example-modal-lg" data-bs-original-title="" title="">Large
                                modal</button>

                            <!-- Small modal-->
                            <button class="btn btn-primary custom-components" type="button" data-bs-toggle="modal"
                                data-bs-target=".bd-example-modal-sm" data-bs-original-title="" title="">Small
                                modal</button>
                        </div>
                    </div>
